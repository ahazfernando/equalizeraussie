      ...
      <section className="py-20 bg-[#0a0a0a]">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl lg:text-5xl text-white italic uppercase tracking-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
            {[
              { num: '01', title: 'INITIAL CONSULTATION', desc: 'Get in touch with our team to discuss your caravan needs. We\'ll help you explore our models, understand your requirements, and find the perfect fit for your lifestyle and adventures.' },
              { num: '02', title: 'CUSTOMIZATION & DESIGN', desc: 'Work with our specialists to customize your caravan. Choose your floor plan, select features, and personalize every detail to create your dream RV that matches your unique travel style.' },
              { num: '03', title: 'MANUFACTURING & BUILD', desc: 'Watch your caravan come to life in our Australian facility. Our skilled craftsmen use premium materials and precision engineering to build your caravan to the highest standards of quality and durability.' },
              { num: '04', title: 'DELIVERY & HANDOVER', desc: 'Experience the excitement of receiving your new caravan. We provide comprehensive handover training, warranty support, and ongoing service to ensure you\'re ready for your next adventure.' },
            ].map((step) => (
              <div key={step.num} className="flex flex-col">
                {/* Large faded number */}
                <span className="font-display text-8xl lg:text-9xl text-white/10 leading-none mb-6">
                  {step.num}
                </span>
                
                {/* Title */}
                <h3 className="font-display text-2xl lg:text-3xl text-white uppercase tracking-wider mb-3">
                  {step.title}
                </h3>
