  ...
  return (
    <>
      ...
      <section className="relative min-h-[90vh] lg:min-h-screen flex items-center overflow-hidden -mt-24 pt-24 pb-0">
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 hidden lg:block opacity-100">
      ...
      <section className="py-20 bg-background overflow-hidden">
        <div className="container mx-auto px-0">
          ...
          >
            ...
            <h2 className="font-heading text-5xl sm:text-6xl lg:text-6xl font-extrabold leading-[1.1] mb-8">
      ...
      <section ref={sectionRef} className="relative pt-16 lg:pt-24 pb-24 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-5xl mx-auto relative pt-8">
            ...
            {/* Bottom Stats */}
            <div className="mt-20 lg:mt-32 grid grid-cols-2 gap-6 lg:gap-8">
              {[
      ...
      <section className="relative py-24 lg:py-32 bg-black overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-16 lg:mb-20">
            ...
            <h2 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[0.95] text-white mb-6">
