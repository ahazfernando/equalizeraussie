...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        openGraph: {
            ...
            type: 'article',
            images: [{
                url: article.imageURL && article.imageURL.startsWith('http') 
                    ? article.imageURL 
                    : `https://equalizerrv.com${article.imageURL.startsWith('/') ? article.imageURL : `/blogs/${article.imageURL}` || '/blogs/blog1.png'}`,
                width: 1200,
                height: 630,
                alt: article.title,
            }],
