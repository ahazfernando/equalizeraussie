          ...
          >
            ...
            >
              <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-6xl font-semibold leading-tight">
                <span className="block text-foreground">More Than a Caravan.</span>
                <span className="bg-gradient-to-r from-accent via-accent to-accent/80 bg-clip-text text-transparent relative inline-block">
